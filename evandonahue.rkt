...
(define (navigation [curr-page 'index])
  `(((a.tm href "pdf/cv.pdf") CV)
    ((,(if (eq? curr-page 'publications) 'span.tm 'a.tm) href "publications.html") Publications)
  ...
  (html
   `(html
     ...
     (body	   
      ...
      ((nav.jss.faistr.psb.navborder style (--s-b 100px)) ,@(navigation))
      (aside.tr.mbsb.gcs
	...
	(noscript "Email me at first.last at either the Tokyo College or University of Tokyo domain"))
      ...
      (article.mbsb
       ...
       (p "In my computational work, I consider alternative histories and roads not taken to reconceptualize language and the human and with them the design of AI technologies. I build natural language interfaces that explore both the aesthetic and the functional dimensions of communication, and through these study what it means to communicate with a machine.")))) #t))
