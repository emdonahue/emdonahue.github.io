...
(define (publications)
  (page 'publications
	'("")
	'((p.thi "Donahue, Evan. \"Goals as Constraints: Writing miniKanren Constraints in miniKanren.\" In " (i "Proceedings of the 2023 miniKanren and Relational Programming Workshop") ". Seattle 2023. 1-12. Cambridge:
Harvard University. [" ((a href "https://dash.harvard.edu/bitstream/handle/1/37377201/tr.pdf?sequence=1&isAllowed=y") Link) "]")
	  ...
	  (p.thi "Donahue, Evan. \"Towards an Android Linguistics: Pragmatics, Reflection, and Creativity in Machine Language.\" Proceedings of " (i "Theoretical and Foundational Problems in Information Studies") " 81, no. 1 (July 2022). [" ((a href "https://www.mdpi.com/2504-3900/81/1/156") Link) "]")
